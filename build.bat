...
set compile_debug=      call cl /Od /Ob1 /DBUILD_DEBUG=1 %compile_common% %auto_compile_flags%
set compile_release=    call cl /O2 /DBUILD_DEBUG=0 %compile_common% %auto_compile_flags%
